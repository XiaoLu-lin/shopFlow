...
import org.ysling.litemall.core.system.enums.SystemOrderConfig;
...
public class WxWebCartService {
     ...
     * @return 加入购物车操作结果
     */
    public Object add(String userId, LitemallCart cart) {
     ...
     * @return 立即购买操作结果
     */
    public Object fastAdd(String userId, LitemallCart cart) {
        String goodsId = cart.getGoodsId();
        String productId = cart.getProductId();
     ...
     * @return 修改结果
     */
    public Object update(String userId, LitemallCart cartItem) {
        ...
        //判断是否存在该订单
        // 如果不存在，直接返回错误
        LitemallCart existCart = cartService.findById(userId, cartId);
        if (existCart == null) {
