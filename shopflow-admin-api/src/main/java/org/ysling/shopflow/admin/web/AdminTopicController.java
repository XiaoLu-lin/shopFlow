...
import org.ysling.shopflow.admin.model.topic.result.TopicReadResult;
...
import org.ysling.shopflow.admin.service.AdminTopicService;
...
public class AdminTopicController {
    ...
    @PostMapping("/create")
    public Object create(@Valid @RequestBody ShopflowTopic topic) {
    ...
    @PostMapping("/update")
    public Object update(@Valid @RequestBody ShopflowTopic topic) {
        Object error = topicService.validate(topic);
        if (error != null) {
            return error;
        }
