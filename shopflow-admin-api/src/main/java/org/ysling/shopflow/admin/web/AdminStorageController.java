...
import org.ysling.shopflow.admin.model.storage.result.StorageUploadFileResult;
...
import org.ysling.shopflow.admin.service.AdminStorageService;
...
public class AdminStorageController {
    ...
    @PostMapping("/update")
    public Object update(@Valid @RequestBody ShopflowStorage storage) {
    ...
    public Object uploadFile(@RequestParam("upfile") MultipartFile file) {
        ...
        try {
            ShopflowStorage storage = storageService.store(file);
            result.setState("SUCCESS");
            result.setOriginal(file.getName());
            result.setSize(storage.getSize().longValue());
