...
import org.ysling.shopflow.admin.service.AdminFeedbackService;
...
public class AdminFeedbackController {
     ...
     * 查询
     */
    @SaCheckPermission("admin:feedback:list")
    @RequiresPermissionsDesc(menu = {"用户管理", "意见反馈"}, button = "查询")
    @GetMapping("/list")
    public Object list(FeedbackListBody body) {
        return ResponseUtil.okList(feedbackService.querySelective(body));
    }
