...
public class AdminKeywordService extends KeywordServiceImpl {
    ...
    public Object validate(ShopflowKeyword keywords) {
    ...
    @Cacheable(sync = true)
    public List<ShopflowKeyword> querySelective(KeywordListBody body) {
        ...
        if (StringUtils.hasText(body.getUrl())) {
            wrapper.like(ShopflowKeyword.URL , body.getUrl());
        }
