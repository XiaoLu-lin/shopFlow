...
import org.ysling.shopflow.db.service.impl.PermissionServiceImpl;
...
public class AdminPermissionService extends PermissionServiceImpl {
    ...
    public Set<String> queryByRoleId(String roleId) {
        ...
        wrapper.eq(ShopflowPermission.ROLE_ID , roleId);
        for(ShopflowPermission permission : list(wrapper)){
    ...
    public Set<String> queryByRoleId(List<String> roleIds) {
        ...
        QueryWrapper<ShopflowPermission> wrapper = new QueryWrapper<>();
        wrapper.in(ShopflowPermission.ROLE_ID , roleIds);
        for(ShopflowPermission permission : list(wrapper)){
            permissions.add(permission.getPermission());
        }
        return permissions;
    ...
    public boolean checkSuperPermission(String roleId) {
        ...
        QueryWrapper<ShopflowPermission> wrapper = new QueryWrapper<>();
        wrapper.eq(ShopflowPermission.ROLE_ID , roleId);
        wrapper.eq(ShopflowPermission.PERMISSION , "*");
    ...
    public void deleteByRoleId(String roleId) {
        UpdateWrapper<ShopflowPermission> wrapper = new UpdateWrapper<>();
        wrapper.eq(ShopflowPermission.ROLE_ID , roleId);
        remove(wrapper);
    }
