...
import org.ysling.shopflow.wx.service.WxCartService;
import org.ysling.shopflow.wx.service.WxCouponService;
import org.ysling.shopflow.wx.service.WxCouponUserService;
...
public class WxWebCouponService {
    ...
    public Object user(String userId, CouponListBody body) {
        List<ShopflowCouponUser> couponUserList = couponUserService.queryList(userId, body);
    ...
    public Object selectList(String userId, String cartId) {
        ...
        for (CouponResult cv : couponVoList) {
            ShopflowCoupon coupon = couponVerifyService.checkCoupon(userId, cv.getCid(), cv.getId(), checkedGoodsList);
    ...
    public Object receive(String userId, String couponId) {
        ShopflowCoupon coupon = couponService.findById(couponId);
        if(coupon == null){
    ...
    public Object exchange(String userId, String code) {
        ShopflowCoupon coupon = couponService.findByCode(code);
        if(coupon == null){
