...
import org.ysling.shopflow.wx.service.WxFeedbackService;
...
public class WxWebFeedbackService {
    ...
    private Object validate(ShopflowFeedback feedback) {
     ...
     * @return 操作结果
     */
    public Object submit(String userId, ShopflowFeedback feedback) {
