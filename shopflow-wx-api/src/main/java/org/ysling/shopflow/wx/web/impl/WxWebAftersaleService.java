...
import org.ysling.shopflow.core.service.NotifyCoreService;
import org.ysling.shopflow.core.service.OrderCoreService;
...
import org.ysling.shopflow.wx.model.aftersale.result.AftersaleDetailResult;
import org.ysling.shopflow.wx.model.aftersale.result.AftersaleListResult;
...
public class WxWebAftersaleService {
    ...
    public Object list(String userId, AftersaleListBody body) {
        List<ShopflowAftersale> aftersaleList = aftersaleService.querySelective(userId, body);
        List<AftersaleListResult> aftersaleVoList = new ArrayList<>(aftersaleList.size());
        for (ShopflowAftersale aftersale : aftersaleList) {
    ...
    public Object detail(String userId, String orderId) {
        ...
        ShopflowAftersale aftersale = aftersaleService.findByOrderId(order.getUserId(), orderId);
        if (aftersale == null){
     ...
     * @return 操作结果
     */
    public Object submit(String userId, ShopflowAftersale aftersale) {
     ...
     * @return 操作结果
     */
    public Object cancel(String userId, ShopflowAftersale aftersale) {
        String id = aftersale.getId();
        if(id == null){
            return ResponseUtil.badArgument();
        }
        ShopflowAftersale aftersaleOne = aftersaleService.findById(userId, id);
     ...
     * 售后退款
     */
    public Object refund(ShopflowAftersale aftersale) {
        return aftersaleCoreService.refund(aftersale.getId());
    }


    private Object validate(ShopflowAftersale aftersale) {
        if (aftersale == null) {
            return ResponseUtil.badArgument();
        }
