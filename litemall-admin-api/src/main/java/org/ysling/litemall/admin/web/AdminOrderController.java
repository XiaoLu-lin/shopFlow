...
import org.ysling.litemall.admin.service.AdminOrderGoodsService;
import org.ysling.litemall.admin.service.AdminOrderService;
import org.ysling.litemall.admin.service.AdminUserService;
import org.ysling.litemall.admin.model.order.body.*;
import org.ysling.litemall.admin.model.order.result.OrderDetailResult;
import org.ysling.litemall.admin.model.order.result.OrderListResult;
...
public class AdminOrderController {
    ...
    public Object list(OrderListBody body) {
        ...
        //查询订单列表
        List<LitemallOrder> orderList = orderService.querySelective(body);
        //拼接订单信息
    ...
    public Object reply(@Valid @RequestBody OrderReplyBody body) {
        ...
        // 目前只支持回复一次
        LitemallGoodsComment comment = goodsCommentService.findById(commentId);
        if(comment == null){
            return ResponseUtil.badArgument();
        }
