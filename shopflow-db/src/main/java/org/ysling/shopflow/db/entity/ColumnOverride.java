...
public class ColumnOverride implements Serializable {
    ...
    public enum TYPE {
         ...
         * Integer数组
         */
        INTEGER("Integer[]","JsonIntegerArrayTypeHandler.class" , "org.ysling.shopflow.db.handler.JsonIntegerArrayTypeHandler"),
        /**
         * String数组
         */
        STRING("String[]","JsonStringArrayTypeHandler.class" , "org.ysling.shopflow.db.handler.JsonStringArrayTypeHandler"),
        /**
         * JsonNode链表
         */
        NODE("JsonNode","JsonNodeTypeHandler.class" , "org.ysling.shopflow.db.handler.JsonNodeTypeHandler");
