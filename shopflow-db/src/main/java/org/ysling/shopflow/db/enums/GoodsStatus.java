...
public enum GoodsStatus implements Serializable {
    ...
    /**判断商品是否待审核*/
    public static Boolean getIsAudit(ShopflowGoods goods){
        return goods.getStatus().equals(GOODS_AUDIT.getStatus());
    }

    /**判断商品是否已上架*/
    public static Boolean getIsOnSale(ShopflowGoods goods){
        return goods.getStatus().equals(GOODS_ON_SALE.getStatus());
    }

    /**判断商品是否已下架*/
    public static Boolean getIsUnsold(ShopflowGoods goods){
        return goods.getStatus().equals(GOODS_UNSOLD.getStatus());
    }

    /**判断商品是否已驳回*/
    public static Boolean getIsReject(ShopflowGoods goods){
