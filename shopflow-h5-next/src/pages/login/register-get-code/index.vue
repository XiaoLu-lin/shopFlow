  ...
  <view class="page">
    <view class="auth-shell">
      ...
      <view class="auth-card">
        ...
        <view class="auth-field">
          <text class="auth-field-label">用户名</text>
          <input
            v-model="username"
            class="auth-field-input"
            type="text"
        ...
        <view class="auth-action-row">
          <view class="auth-ghost" @click="goLogin">已有账号，去登录</view>
        </view>
      </view>
    </view>
  </view>
...
const hero = resolveAuthActionHero('register')
