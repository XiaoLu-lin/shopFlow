...
export function getHome() {
  ...
  return request({
    url: IndexUrl,
    method: 'get',
    params: withAppIdParam(undefined, appid)
  })
}
...
const AuthLoginByAccount='/auth/login_legacy'; //旧 H5 账号登录兼容
...
export function authLogout() {
  return Promise.resolve({ data: { errno: 'success' } })
}
const AuthInfo='/user/info'; //用户信息
...
const AuthRegisterCaptcha='/auth/captcha/mobile'; //注册验证码
...
const AuthCaptcha='/auth/captcha/mobile'; //验证码
