...
import org.ysling.shopflow.core.tasks.impl.DealingSlipMonitorTask;
import org.ysling.shopflow.core.tasks.service.TaskService;
import org.ysling.shopflow.core.weixin.request.WxPartnerTransferRequest;
...
public class WxPayTransferService {
    ...
    public void withdrawDeposit(String openid, String trueName, BigDecimal cashAmountPrice, String outBatchNo) {
        ...
        try {
            ...
            ShopflowDealingSlip dealingSlip = findByOutBatchNo(openid, outBatchNo);
            if (dealingSlip != null){
                //加入延时任务五分钟后检查一次
     ...
     * @return true
     */
    public ShopflowDealingSlip findByOutBatchNo(String openid, String outBatchNo) {
