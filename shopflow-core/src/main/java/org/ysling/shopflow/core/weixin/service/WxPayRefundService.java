...
public class WxPayRefundService {
     ...
     * @param order 订单详情
     */
    public WxPayRefundResult wxPayRefund(ShopflowOrder order){
     ...
     * @param order 订单详情
     */
    public WxPayRefundResult wxPayAftersaleRefund(ShopflowOrder order , ShopflowAftersale aftersaleOne){
        if (order.getPayId() == null){
            throw new RuntimeException("仅线上支付支持微信退款");
        }
        // 微信退款
