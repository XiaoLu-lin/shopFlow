package org.ysling.shopflow.core.satoken.handler;
...
public class AuthenticationInfo {
     ...
     * @param admin 登陆实体
     */
    public static void login(ShopflowAdmin admin) {
     ...
     * @param admin 登陆实体
     */
    public static void loginQr(ShopflowAdmin admin) {
        //添加登陆记录
     ...
     * @param code 验证码
     */
    public static void login(ShopflowAdmin admin, String code) {
        String username = admin.getUsername();
        String password = admin.getPassword();
     ...
     * @param password 密码
     */
    public static ShopflowAdmin login(String username, String password) {
     ...
     * @param code 验证码
     */
    public static ShopflowAdmin login(String username, String password, String code) {
        ...
        //获取数据库账号消息
        List<ShopflowAdmin> adminList = commonService.findAdmin(username);
        ...
        if (!CryptoUtil.matches(password, admin.getPassword())) {
