package org.ysling.shopflow.core.utils.chatgpt;

import cn.hutool.http.HttpRequest;
import cn.hutool.json.JSONUtil;
import org.springframework.beans.factory.annotation.Autowired;
import org.springframework.stereotype.Component;
import org.ysling.shopflow.core.service.StorageCoreService;
...
public class ChatGPTClient {
     ...
     * @return 消息体
     */
    public static ShopflowMessage getResultMessage(String userId, ChatResult chatResult){
        ShopflowMessage resultMessage = new ShopflowMessage();
     ...
     * @return 消息体
     */
    public static ShopflowMessage getMessage(String userId, String content){
        ShopflowMessage resultMessage = new ShopflowMessage();
        resultMessage.setNickName(CHAT_GPT_NICKNAME);
        resultMessage.setAvatarUrl(CHAT_GPT_AVATAR);
     ...
     * @return 回复
     */
    public static ChatResult chatSendMessage(List<ShopflowMessage> historyMessage){
        List<ChatResult.Message> messages = new ArrayList<>();
        for (ShopflowMessage history :historyMessage) {
