package org.ysling.shopflow.core.utils.token;
/**
...
public class TokenJwtHelper {
	...
	/**加密数字签名的秘钥*/
	private static final String SECRET = "X-ShopFlow-User-Token";
	/**签名是有谁生成*/
	private static final String ISSUSER = "ShopFlow";
	/**签名的主题*/
	private static final String SUBJECT = "this is ShopFlow token";
	/**签名的观众*/
