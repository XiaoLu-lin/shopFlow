...
import org.ysling.shopflow.db.enums.CouponUserStatus;
...
public class CouponUserExpiredTask extends TaskRunnable {
    ...
    public CouponUserExpiredTask(ShopflowCouponUser couponUser, long delayInMilliseconds){
    ...
    public void runTask() {
        ...
        ShopflowCouponUser couponUser = couponUserService.findById(this.couponUserId);
