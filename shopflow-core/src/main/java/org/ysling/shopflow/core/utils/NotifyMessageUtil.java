...
public class NotifyMessageUtil {
    ...
    public static String orderMessage(ShopflowOrder order , ShopflowOrderGoods orderGoods){
        ...
        inform.append("<p>");
        inform.append("<a href=\"http://shopflow.ysling.site\" style='font-size: 16px; line-height: 45px; display: block; background-color: rgb(0, 164, 255); color: rgb(255, 255, 255); text-align: center; text-decoration: none; margin-top: 20px; border-radius: 3px;'>去发货</a>");
        inform.append("</p>");
    ...
    public static String refundMessage(ShopflowOrder order , ShopflowOrderGoods orderGoods){
        StringBuilder inform = new StringBuilder("<html><head></head><body>");
        inform.append("<table border='1' style='font-size:15px;width:100%;'>");
        inform.append("<thead>");
        ...
        inform.append("<p>");
        inform.append("<a href=\"http://shopflow.ysling.site\" style='font-size: 16px; line-height: 45px; display: block; background-color: rgb(0, 164, 255); color: rgb(255, 255, 255); text-align: center; text-decoration: none; margin-top: 20px; border-radius: 3px;'>去查看</a>");
        inform.append("</p>");
     ...
     * @return
     */
    public static String aftersaleMessage(ShopflowOrder order ,ShopflowOrderGoods orderGoods, ShopflowAftersale aftersale){
        StringBuilder inform = new StringBuilder("<html><head></head><body>");
        inform.append("<table border='1' style='font-size:15px;width:100%;'>");
        inform.append("<thead>");
