package org.ysling.shopflow.core.utils.Inheritable;
 ...
 * @author Ysling
 */
public abstract class InheritableSupplier<V> extends TaskWithCache implements Supplier<V> {

    public InheritableSupplier(){
        super();
    }
