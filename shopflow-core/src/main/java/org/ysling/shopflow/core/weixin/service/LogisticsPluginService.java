package org.ysling.shopflow.core.weixin.service;
...
import org.ysling.shopflow.core.weixin.request.GoodsDetail;
import org.ysling.shopflow.core.weixin.request.WxLogisticsRequest;
...
public class LogisticsPluginService {
    ...
    public Object getWaybillToken(String userId, String orderSn) throws WxErrorException {
        ...
        ShopflowOrder order = commonService.findBySn(userId, orderSn);
        if (order == null){
        ...
        List<ShopflowOrderGoods> goodsList = commonService.queryByOid(order.getId());
        for (ShopflowOrderGoods orderGoods :goodsList) {
