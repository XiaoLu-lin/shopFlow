...
import org.ysling.shopflow.core.transaction.interceptor.LocalTransactionInterceptor;
...
public class GlobalTransactionalAspect {
    ...
    /** 配置切入点表达式*/
    private static final String POINTCUT_EXPRESSION = "execution(public * org.ysling.shopflow.*.web.*.*(..))";
