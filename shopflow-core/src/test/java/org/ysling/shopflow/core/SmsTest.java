 ...
 * 测试短信发送服务
 * <p>
 * 注意ShopflowNotifyService采用异步线程操作
...
public class SmsTest {
    ...
    public void testCaptcha() {
        ...
        mobileService.notifySmsTemplate(phone, NotifyType.CAPTCHA, params);
    }
    ...
    public void testPaySucceed() {
        ...
        mobileService.notifySmsTemplate(phone, NotifyType.PAY_SUCCEED, params);
    }
    ...
    public void testShip() {
        ...
        mobileService.notifySmsTemplate(phone, NotifyType.SHIP, params);
    }
